  ...
  const userLinks = () => {
    return (
      <div className="card mt-4">
        <h4 className="card-header bg-gradient-to-r from-yellow-400 to-yellow-600 text-white font-weight-bold text-center">
          User Links
        </h4>
  ...
  const userInfo = () => {
    return (
      <div className="card mb-5 mt-4">
        <h3 className="card-header  bg-gradient-to-r from-yellow-500 to-yellow-700 text-white font-weight-bold text-center">
          User Information
        </h3>
        <ul className="list-group">
