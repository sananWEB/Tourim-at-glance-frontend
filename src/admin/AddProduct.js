...
const AddProduct = () => {
    ...
    const newPostForm = () => (
        ...
        <form className="mb-3" onSubmit={clickSubmit}>
            ...
            <div className="form-group">
                <label className="text-muted">Travel Agancy</label>
            ...
            <div className="form-group">
                ...
                <input onChange={handleChange('quantity')} type="number" min={0} max={5} className="form-control" value={quantity} />
            </div>

            <div className="form-group">
                <label className="text-muted">Trip Days</label>
                <input onChange={handleChange('days')} type="number" min={0} max={90} className="form-control" value={days} />
            </div>
