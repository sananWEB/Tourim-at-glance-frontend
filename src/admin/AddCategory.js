    ...
    const newCategoryFom = () => (
        ...
        <form onSubmit={clickSubmit}>
            <div className="form-group">
                <label className="text-muted">Agancy Name</label>
                <input
                    type="text"
...
<label className="text-muted">Agancy email</label>
                <input
                    type="email"
                    className="form-control"
                    onChange={handleChange}
...
<label className="text-muted">Agancy number</label>
                <input
                    type="number"
                    className="form-control"
                    onChange={handleChange}
...
<label className="text-muted">About Us</label>
    ...
    const showSuccess = () => {
        if (success) {
            return <h3 className="text-success my-2 p-2 border shadow border-success rounded">{name.name1} is created</h3>;
        }
    };
